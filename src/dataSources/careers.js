export default [
  ...
  },
  {
    ...
    description: `[Utopian](https://steemit.com/@utopian-io) was an early staging company with a disrupting open-source technology aiming to reward open-source contributors. It was a very purpose-driven company where I had the opportunity to work with great minds from Europe, Asia, Africa, and South America towards a common goal to help open source communities grow and thrive.
      ...
      \nI worked in the development of the Utopian v2 platform using vue.js with the Quasar framework; Node.JS and MongoDB in the backend, integrating with the Steem blockchain as well with other decentralized technologies such as IPFS.
      \nI had the opportunity to [meet the team in Italy](https://steemit.com/fundition-ffdnxgdga/@steemstem/steemstem-and-utopian-io-meetup-in-italy-updates-from-our-fundition-campaign-and-more) and it was one of the greatest experiences in my whole career!
      \nUnfortunately, for a few reasons, including a lack of a proper business model, the company doesn't exist anymore.`,
    stack: [
      "blockchain",
      "vue",
      "quasar",
  ...
  },
  {
    ...
    \nThe whole software was open source and that was the first time that I had the opportunity to work in a fully transparent workflow, since the day-to-day coding to our deployment processes, we documented everything to then make it public for our investors.
    \nIt was a great experience and it was when I fell in love with open-source software.`,
    stack: [
      "blockchain",
      "ethereum",
      "web3",
